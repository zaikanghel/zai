...
import Countdown from "../utils/Countdown"; // Import the Countdown component
		...
		>
			...
			<div className='space-y-6'>
				...
				>
					...
					<p className='text-gray-300'>Subscription: {user.subscription}</p>
				</motion.div>
				<motion.div
					className='p-4 bg-gray-800 bg-opacity-50 rounded-lg border border-gray-700'
					initial={{ opacity: 0, y: 20 }}
				...
				>
					<h3 className='text-xl font-semibold text-purple-500 mb-3'>Account Activity</h3>
			...
			>
				...
				font-bold rounded-lg shadow-lg hover:from-purple-500 hover:to-indigo-600
